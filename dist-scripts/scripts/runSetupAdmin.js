...
var setupAdmin_1 = require("../src/utils/setupAdmin");
var ensureProfiles_1 = require("./ensureProfiles");
var updateAdminRoles_1 = require("./updateAdminRoles");
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, setupAdmin_1.setupAdmin)()];
            case 1:
                _a.sent();
                console.log("Ensuring all users have profiles...");
                return [4 /*yield*/, (0, ensureProfiles_1.ensureProfiles)()];
            case 2:
                _a.sent();
                console.log("Updating all users to admin role...");
                return [4 /*yield*/, (0, updateAdminRoles_1.updateAdminRoles)()];
            case 3:
                _a.sent();
