    ...
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-white">
              ...
              <p className="text-lg md:text-xl mb-8">
                Explore our wide range of snacks, soaps, detergents, and food
                ingredients at wholesale prices with convenient home delivery.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/products">
                  <Button
                    size="lg"
                    className="bg-mondoYellow hover:bg-yellow-500 text-mondoBlue font-bold w-full sm:w-auto mb-2 sm:mb-0"
                  >
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    <Link to="/login" className="w-full sm:w-auto">
                      <Button
                        size="lg"
                        variant="secondary"
                        className="bg-white text-blue-600 hover:bg-gray-100 w-full mb-2 sm:mb-0"
                      >
                        Login
                      </Button>
                    </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Get the best prices when you buy in bulk for your business or
                home.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                We source the highest quality products for your satisfaction.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-600">
                Enjoy convenient home delivery or pickup options for your
                orders.
              </p>
            </div>
      ...
      <section className="bg-mondoYellow py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4 text-mondoBlue">
            Ready to Start Saving?
          </h2>
          <p className="text-lg mb-8 text-gray-800 max-w-2xl mx-auto">
            Join thousands of satisfied customers who save money by buying in
            bulk from Mondo Carton King.
          </p>
          <Link to="/products">
            <Button
              size="lg"
              className="bg-mondoBlue hover:bg-blue-700 text-white font-bold"
            >
              <ShoppingBag className="mr-2" size={20} />
              Shop Now
            </Button>
