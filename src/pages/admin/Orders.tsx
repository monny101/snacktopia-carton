...
import { Search, FileText, ArrowUp, ArrowDown, Loader2 } from "lucide-react";
...
const AdminOrders: React.FC = () => {
  ...
  const handleStatusUpdate = async (orderId: string, newStatus: string) => {
    try {
      ...
      if (error.code === "42501") {
        errorMessage =
          "Permission denied. You need admin or staff privileges to update order status.";
            ...
            <div className="py-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm">
                    Name: {selectedOrder.profiles?.full_name || "N/A"}
                  </p>
                  <p className="text-sm">
                    Phone: {selectedOrder.profiles?.phone || "N/A"}
                  </p>
